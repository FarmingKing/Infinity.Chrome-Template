...
using static GunLibTest.GunLibTest1;
using GunLibTest;
    ...
    public class Buttons
    {
        ...
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Movement Mods [5]
                ...
                new ButtonInfo { buttonText = "Gun Test (No Lock)", method =() => GunLibTest1.TestGunLib(), toolTip = "Teleports you to wherever your pointer is when pressing trigger."},
                new ButtonInfo { buttonText = "Gun Test (Lock)", method =() => GunLibTest1.TestGunLibLOCK(), toolTip = "Teleports you to wherever your pointer is when pressing trigger."},
            },
            ...
            new ButtonInfo[] { // Dont touch these please

                new ButtonInfo { buttonText = "Disconnect", method =() => NetworkSystem.Instance.ReturnToSinglePlayer(), isTogglable = false, toolTip = "Disconnects you from the room."},
                new ButtonInfo { buttonText = "Home", method =() => currentCategory = 0, isTogglable = false, toolTip = "Returns to the main page of the menu."},
            },
        };
    }
}
