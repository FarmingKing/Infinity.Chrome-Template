...
namespace StupidTemplate.Menu
{
    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void CreateMenu()
        {
            ...
            MenuOutline.transform.localScale = new Vector3(0.098f, 1.02f, 1.02f);
            MenuOutline.transform.position = new Vector3(0.05f, 0f, 0f);
            MenuOutline.GetComponent<Renderer>().material.color = outlineColor[0].colors[0].color;
            RoundObj(MenuOutline, 0.01f);
            ...
            if (disconnectButton)
            {
                ...
                RoundObj(disconnectbutton, 0.01f);
                    ...
                    transform =
            {
                ...
                rectt.localPosition = new Vector3(0.064f, 0f, 0.223f);
            ...
            gameObject.transform.localScale = new Vector3(0.06f, 0.2f, 0.10f);
            gameObject.transform.localPosition = new Vector3(0.56f, 0.4f, -0.6f);
            gameObject.GetComponent<Renderer>().material.color = PageButtonColors[0].colors[0].color;
            gameObject.AddComponent<Classes.Button>().relatedText = "PreviousPage";
            RoundObj(gameObject, 0.01f);
            ...
            component.localPosition = new Vector3(0.06f, 0.12f, -0.23f);
            component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
            ...
            gameObject.transform.localScale = new Vector3(0.06f, 0.2f, 0.10f);
            gameObject.transform.localPosition = new Vector3(0.56f, -0.4f, -0.6f);
            gameObject.GetComponent<Renderer>().material.color = PageButtonColors[1].colors[0].color;
        ...
        public static void CreateButton(float offset, ButtonInfo method)
        {
            ...
            gameObject.GetComponent<Renderer>().material.color = method.enabled ? buttonColors[1].colors[0].color : buttonColors[0].colors[0].color;
            RoundObj(gameObject, 0.01f);
            ...
            Home.GetComponent<Renderer>().material.color = homebuttonColor[0].colors[0].color;
            ...
            gameObject1.GetComponent<Renderer>().material.color = homebuttonColor[0].colors[0].color;
            RoundObj(gameObject1, 0.01f);
