    ...
    public class Safety
    {
        ...
        public static void AntiReportDisconnect()
        {
            AntiReport((vrrig, position) =>
            {
                ...
                NotifiLib.SendNotification("<color=grey>[</color><color=blue>KINGS MENU</color><color=grey>]</color> " + GetPlayerFromVRRig(vrrig).NickName + " attempted to report you, King's Menu has stopped it.");
            });
        }
    }
}
